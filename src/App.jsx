...
// ═══════════════════════════════════════════════════════════════════════════════
// STORE — window.__store (in-memory, persistent in session) v2
// ═══════════════════════════════════════════════════════════════════════════════
const FOOD_IMAGES = {
...
function CompletedTab({ refresh }) {
  ...
  const cancelledAll = store.cancelledOrders || [];
  ...
  const filtCancelled = cancelledAll.filter(o => {
...
function WaiterPage({ onBack }) {
  ...
  const { store, refresh } = useStore();
  const addToEditWaiter = (menuItem) => {
    setEditOrder(p => {
      if (!p) return p;
